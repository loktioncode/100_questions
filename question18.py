...
them according to the above criteria. Passwords that match the criteria are to be printed, each separated by a comma.
Example
...
passwords = raw_input("Enter Password: ").split(",")
value = []
